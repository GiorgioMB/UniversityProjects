...
Cliff_U = np.array(Clifford_op.to_matrix(), requires_grad=False)
...
if __name__ == "__main__":
    ...
    plt.savefig("clifford_qml_results.png", dpi=600, bbox_inches="tight")
    plt.show()
    ...
    df_all.to_csv("qml_results_clifford.csv", index=False)
    ...
    df_fid.to_csv("qml_results_clifford_fidelities.csv", index=False)
    print("[MAIN] Done.")
