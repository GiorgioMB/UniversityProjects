...
if __name__ == "__main__":
    ...
    for stats_d, label, col in [
        ...
        (n_loss, "H Initialized Ancillary", "orange"),
    ]:
        sns.lineplot(
    ...
    for stats_d, label, col in [
        ...
        (n_grad, "H Initialized Ancillary", "orange"),
    ]:
        sns.lineplot(
            x=epochs, y=stats_d['mean'],
    ...
    ax3.set(
        xticks=[0, 1],
        xticklabels=["0 Initialized Ancillary", "H Initialized Ancillary"],
        ylabel="Test MSE",
    ...
    df_loss = pd.DataFrame({
        ...
        '0 Initialized Ancillary Loss': loss_b_np.flatten(),
        'H Initialized Ancillary Loss': loss_n_np.flatten(),
        '0 Initialized Ancillary Gradient Norm': grad_b_np.flatten(),
        'H Initialized Ancillary Gradient Norm': grad_n_np.flatten(),
    })
