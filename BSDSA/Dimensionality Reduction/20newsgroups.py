...
newsgroups  = fetch_20newsgroups(remove=('headers', 'footers', 'quotes'), 
                                            data_home='/home/3121346/scikit_learn_data/20news_home/',
                                            subset='all',
...
adj_matrix = kneighbors_graph(X, k, metric="cosine",mode='connectivity', include_self=False)
...
#plt.show()
plt.savefig('/home/3121346/gvae/figures/vae_vgae_recon_loss.png', dpi=150, bbox_inches='tight')
...
# mark_inset(ax_main, ax_inset, loc1=2, loc2=4, fc="none", ec="0.5")
#plt.show()
plt.savefig('/home/3121346/gvae/figures/vae_vgae_ae_recon_loss.png', dpi=150, bbox_inches='tight')
...
plt.legend()
#plt.show()
plt.savefig('/home/3121346/gvae/figures/node2vec_recon_loss.png', dpi=150, bbox_inches='tight')


with open('/home/3121346/gvae/loss_results/loss', 'wb') as f:
    pickle.dump((trad_loss_kl, kl_losses, trad_ae_losses, n2v_losses), f)

with open('/home/3121346/gvae/loss_results/recon_loss', 'wb') as f:
    pickle.dump((trad_loss_recon, recon_losses, trad_ae_losses), f)
...
plt.legend(*scatter.legend_elements(), title="NewsPapers")
plt.xticks([])
plt.yticks([])
plt.title('t-SNE Visualization of VGAE Embeddings')
#plt.show()
plt.savefig('/home/3121346/gvae/figures/t-SNE_for_vgae.png', dpi=150, bbox_inches='tight')
...
#plt.show()
plt.savefig('/home/3121346/gvae/figures/t-SNE_for_node2vec.png', dpi=150, bbox_inches='tight')
...
#plt.show()
plt.savefig('/home/3121346/gvae/figures/t-SNE_for_vae.png', dpi=150, bbox_inches='tight')
...
#plt.show()
plt.savefig('/home/3121346/gvae/figures/t-SNE_for_pca.png', dpi=150, bbox_inches='tight')
...
#plt.show()
plt.savefig('/home/3121346/gvae/figures/downstream_task_loss.png', dpi= 150,bbox_inches='tight')

with open('/home/3121346/gvae/loss_results/downstream.txt', 'wb') as f:
    pickle.dump([losses_pca_downstream, losses_mds_downstream, losses_isomap_downstream, losses_lle_downstream, losses_ltsa_downstream, losses_laplacian_downstream, losses_diffmap_downstream, losses_ae_downstream, losses_vae_downstream, losses_n2v_downstream, losses_vgae_downstream], f)
